...
export default function Pile( size, initialValues ){
...
Pile.wrapMethod = function( methodName, trimMethod ){
...
Pile.push = Pile.wrapMethod(
    "push",
    Pile.trimHead
);
Pile.splice = Pile.wrapMethod(
    "splice",
    Pile.trimTail
);
Pile.unshift = Pile.wrapMethod(
    "unshift",
    Pile.trimTail
);
// -------------------------------------------------- //
